...
/* Define the vertex positions for a sphere. The array of vertices must have previosuly
   been created. 
  */
void sphere_lab::makeUnitSphere(GLfloat *pVertices, GLuint numlats, GLuint numlongs)
{
...
GLuint sphere_lab::incrementDrawmode(GLuint value)
{
	return this->drawmode = this->drawmode + value;
}

void sphere_lab::setDrawMode(GLuint value)
{
	this->drawmode = value;
}